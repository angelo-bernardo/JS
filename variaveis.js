...
const constVariavel = "É uma variável somente leitura, a qual não poderã ser alterada, ocasionando um errono console";
console.log("constVariavel", constVariavel);

let letVariavel = "É uma variável que será declarada apenas o mesmo bloco de códigos e, logo em seguida, será eliminada da memória/interaface";
